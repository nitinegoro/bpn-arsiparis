		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default turun">
			  ...
			  <div class="panel-body">
			    ...
			    <p><br>This is a message from the Developer Software,</p>
			    <p>that the pages you visit may not be accessed directly, please go back to the application.</p>
			  </div>
			  <div class="panel-footer">
			  	<small>Powered By :</small>
			  	<img src="../images/teitralogo.png" width="250">
			  	<a href="http://127.0.0.1/bpn/" class="btn btn-default pull-right hidden-xs"><i class="fa fa-sign-out"></i> Back to application</a>
			  </div>
			</div>
		</div>
	</div>
