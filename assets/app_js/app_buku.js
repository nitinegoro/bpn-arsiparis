...
$(document).ready(function() {
    $('#add_buku')
        .formValidation({
            excluded: [':disabled'],
            fields: {
                lemari: { validators: { notEmpty: { message: 'Pilih Salah Satu Lemari.' } } },
                rak: { validators: { notEmpty: { message: 'Pilih Salah Satu Rak.' } } },
                album: { validators: { notEmpty: { message: 'Pilih Salah Satu Album.' } } },
                no_halaman: { validators: { notEmpty: { message: 'Pilih Salah Satu Slot yang tersedia.' } } },
                hak: { validators: { notEmpty: { message: 'Pilih salah satu' } } },
                nohak: { validators: { notEmpty: { message: 'Harap diisi.' } } },
                tahun: { validators: { notEmpty: { message: 'Harap diisi.' } } },
                no208: { validators: { notEmpty: { message: 'Harap diisi.' } } },
                luas: { validators: { notEmpty: { message: 'Harap diisi.' } } },
                kecamatan: { validators: { notEmpty: { message: 'Harap diisi.' } } },
                desa: { validators: { notEmpty: { message: 'Harap diisi.' } } },
            }
        })
    ...
    $('#lemari').change(function() {
        $.ajax({
            ...
            success: function (data) {
                $('#rak').empty();
                if(data.status == true ) {
                    $('#rak').append('<option value="">~ PILIH ~ </option>');
    ...
    $('#rak').change(function() {
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data.status == true ) {
                    $('#album').html('<option value="">~ PILIH ~</option>');
                    var option = '';
                    ...
                    $('#album').append('<option value="">~ PILIH ~ </option>');
                }
            }
        });
        return false;
