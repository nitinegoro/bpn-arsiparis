                  ...
                  <div class="col-md-12">
                    <table class="table table-bordered">
                      ...
                      <tr class="bg-warning">
                        ...
                        <td><?php echo $prov->nama_kecamatan; ?></td>
                        <td><?php echo $kab->nama_desa; ?></td>
                        <td><?php echo $this->db->get_where('tb_buku_tanah', array('id_kecamatan'=>$prov->id_kecamatan))->num_rows(); ?></td>
                      ...
                      if($row->id_kecamatan==7) : continue; endif; ?>
                        <tr>
                          ...
                          <td><?php echo $this->db->get_where('tb_buku_tanah', array('id_kecamatan'=>$row->id_kecamatan))->num_rows(); ?></td>
                          <td class="text-center">
