                ...
                <div class="box-body">
                  <div class="col-md-12">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                      <?php 
                      $no = (!$this->input->get('page')) ? 0 : $this->input->get('page'); foreach($data_desa as $row) : ?>
                        <tr>
                          <td><?php echo ++$no; ?>.</td>
                          <td><?php echo $row->nama_desa; ?></td>
                          <td><?php echo $this->db->get_where('tb_buku_tanah', array('id_desa'=>$row->id_desa))->num_rows(); ?></td>
