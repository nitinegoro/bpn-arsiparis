                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="nav-tabs-custom tab-warning">
                        ...
                        <form id="form_edit_buku" action="<?php echo site_url("apps/app_buku/update/{$data->id_bukutanah}") ?>" method="post">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-xs-7">
                                    <select name="hak" id="" class="form-control">
                                      ...
                                      <?php foreach($this->mbpn->jenis_hak() as $row) : $sama = ($data->id_hak==$row->id_hak) ? 'selected' : '';
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-xs-7">
                                    <select name="status" id="" class="form-control">
                                      <option value=""<?php echo (!$data->status_buku) ? 'selected' : ''; ?>>~ PILIH ~</option>
                          ...
                          <div class="tab-pane" id="step3-tab">
                            <div class="row">
                              <div class="col-md-12">
                                ...
                                <div class="col-md-2 padding-top">
                                  <button type="button" onclick="foto_buku_hapus('<?php echo $data->id_bukutanah ?>');" class="btn btn-sm btn-default">Terapkan</button>
                                </div>
                                  ...
                                  <?php $no=1; foreach($file as $row) : ?>
                                    <tr>
                                      ...
                                      <td width="50" class="text-center">
                                        <a href="#" onclick="delete_file_buku('<?php echo $row->id; ?>','<?php echo $data->no_hakbuku; ?>','<?php echo $data->id_bukutanah; ?>')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
                                      </td>
                                    </tr>
                                  <?php endforeach; ?>
                                  </tbody>
...
<div class="modal" id="modal_add_file" tabindex="-1" data-backdrop="static" data-keyboard="false">
  ...
  <form id="form_add_file" method="POST" class="form-horizontal" action="<?php echo site_url("apps/file_buku/add_multiple/{$data->id_bukutanah}/{$data->no_hakbuku}") ?>" enctype="multipart/form-data"  accept-charset="utf-8">
    <div class="modal-content">
      <div class="modal-header">
