<?php $session = $this->session->userdata('login'); ?>
              ...
              <div class="box box-warning">
                      ...
                      <div class="col-md-4">
                        <table>
                          ...
                          <tr>
                            ...
                            <td width="20px" class="text-center">:</td>
                            <td>
                            <?php if($this->m_buku->keterangan($data->id_bukutanah)) : ?>
                        ...
                        <?php if($this->m_buku->keterangan($data->id_bukutanah)) : $pinjam = $this->m_buku->get_pinjam($data->id_bukutanah); ?>
                          <tr>
                    ...
                    <?php endif; ?>
                      ...
                      <?php if('viewer' != $session['level_akses']) : ?>
          						<div class='list-group gallery'>
            						<?php $no=1; foreach($this->m_buku->file(0, $data->id_bukutanah) as $row) : ?>
                ...
                <div class="box-footer">
                	<div class="btn-group pull-right">
                		<a href="<?php echo site_url("buku/document/{$data->id_bukutanah}?t=data") ?>" class="btn btn-default btn-sm"><i class="fa fa-edit"></i> Edit Dokumen</a>
                    <?php if($this->m_buku->keterangan($data->id_bukutanah)) : ?>
                    ...
                    <?php endif; 
                      if($session['level_akses']=='admin' OR $session['level_akses']=='super_admin') : 
                        if($this->mtrash->cek($data->id_bukutanah)) : 
                    ?>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <a href="<?php echo site_url("apps/app_buku/delete_all/{$data->id_bukutanah}/{$data->no208}"); ?>" type="button" class="btn btn-outline"> Hapus Semua</a>
                  </div>
                </div><!-- /.modal-content -->
              </div><!-- /.modal-dialog -->
            </div><!-- /.modal -->
            ...
            <div class="modal modal-default" id="modal_pinjam_buku_tanah" tabindex="-1" data-backdrop="static" data-keyboard="false">
              <div class="modal-dialog">
                <form action="<?php echo site_url("apps/app_buku/pinjam_buku/{$data->id_bukutanah}") ?>" method="post">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal modal-default" id="modal_kembali_buku_tanah" tabindex="-1" data-backdrop="static" data-keyboard="false">
              <form action="<?php echo site_url("apps/app_buku/kembali_buku/{$data->id_bukutanah}") ?>" method="post">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
