                    ...
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        ...
                        <?php foreach ($this->m_apps->kecamatan() as $row) { ?>
                          <li><i class="fa fa-circle-o" style="color: <?php echo colorChart($row->id_kecamatan); ?>;"></i> <?php echo $row->nama_kecamatan; ?></li>
                        <?php } ?>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        ...
                        <?php foreach ($this->m_landbook->tampilhak() as $row) { ?>
                          <li><i class="fa fa-circle-o" style="color: <?php echo colorChart($row->id_hak); ?>;"></i> <?php echo $row->jenis_hak; ?></li>
                        <?php } ?>
                        </ul>
                      </div>
                    </div>
