...
class App_warkah extends CI_Controller {
	...
	public function index()
	{
		...
		$query = $this->db->query("SELECT tb_warkah.*, tb_buku_tanah.* FROM tb_warkah JOIN  tb_buku_tanah ON tb_warkah.id_bukutanah =  tb_buku_tanah.id_bukutanah WHERE tb_warkah.no208 = '{$where['no']}' AND tb_warkah.tahun = '{$where['thn']}'");
	...
	{
		$row = $this->db->query("SELECT tb_warkah.*, tb_buku_tanah.* FROM tb_warkah JOIN tb_buku_tanah ON tb_warkah.id_bukutanah =  tb_buku_tanah.id_bukutanah WHERE tb_warkah.id_warkah = '{$ID}'")->row();
	...
	{
		$data = $this->db->query("SELECT tb_warkah.*, tb_buku_tanah.* FROM tb_warkah INNER JOIN  tb_buku_tanah ON tb_warkah.id_bukutanah =  tb_buku_tanah.id_bukutanah WHERE tb_warkah.id_warkah = '{$ID}'")->row();
		// data history
		$data_history = array(
			'nip' => $this->nip,
			'tanggal' => date('Y-m-d'),
